            ...
            <div class="col-md-5 mx-auto">
                <div class="form mt-5">
                    ...
                    <?php echo form_open_multipart('utilisateurs/inscription', $data); ?>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox" style="color:black">
                                <input type="checkbox" class="custom-control-input" id="confidentialité">
                                <label class="custom-control-label text-secondary mt-2" for="confidentialité">J'accepte les <a href="javascript:void(0)" onclick="openPoliqueCookies()">règles de confidentalité d'Oporctunité</a></label>
            ...
            <div class="col-md-5 mx-auto">
                <div class="form mt-5">
                    ...
                    <?php echo form_open_multipart('utilisateurs/inscription', $data); ?>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox" style="color:black">
                                <input type="checkbox" class="custom-control-input" id="confidentialité2">
                                <label class="custom-control-label text-secondary mt-2" for="confidentialité2">J'accepte les <a href="javascript:void(0)" onclick="openPoliqueCookies()">règles de confidentalité d'Oporctunité</a></label>
...
<script type="text/javascript"> 
    ...
    function openPoliqueCookies() {
        if (document.getElementById("selectchange").selectedIndex == 0) {
            ...
            document.getElementById("poliqueCookies2").style.display = "block";
            document.getElementById("page-top").style.overflow="hidden";
        }
    }
    ...
    function closePoliqueCookies() {
        if (document.getElementById("selectchange").selectedIndex == 0) {
            ...
            document.getElementById("poliqueCookies2").style.display = "none";
            document.getElementById("page-top").style.overflow="unset";
        }
    }
</script>
