...
(function () {
    ...
    formulaire.addEventListener('submit', function (e) {
        ...
        var confidentialité = document.getElementById('confidentialité'),
            tooltipStyle = getTooltip(confidentialité);
        if (confidentialité.checked == false) {
            tooltipStyle.className = 'd-inline-block bg-danger';
            e.preventDefault();
        }
    }, false);
    ...
    formulaire2.addEventListener('input', function (e) {
        ...
        var confidentialité2 = document.getElementById('confidentialité2'),
            tooltipStyle = getTooltip(confidentialité2);
        if (confidentialité2.checked == false) {
            tooltipStyle.className = 'd-inline-block bg-danger';
            e.preventDefault();
        }
    }, false);
